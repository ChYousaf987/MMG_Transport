...
const fleetData = [
  { name: "Pickup", img: "/shazor.png", cap: "500 KG" },
  { name: "Shahzore", img: "/shahzor.png", cap: "2 Ton" },
  { name: "Mazda", img: "/mazda.png", cap: "5 Ton" },
  { name: "Ten Wheeler", img: "/ten-wheeler.png", cap: "16 Ton" },
  { name: "Bedford Truck", img: "/bedforde.png", cap: "9 Ton" },
  {
    name: "20 Feet Container",
    img: "/container.png",
    cap: "Heavy Cargo",
  },
  { name: "Crane", img: "/crane.png", cap: "Loading & crane" },
  { name: "Lifter", img: "/lifter.png", cap: "Loading & Lifting" },
];
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            A diverse and well-maintained fleet to ensure safe, efficient, and
            on-time transportation across Pakistan.
          </p>
        </motion.div>
